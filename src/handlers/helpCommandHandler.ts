...
*주요 기능*
- \`/help\`: 이 도움말을 표시합니다.
- \`/gemini\` (별칭: \`/g\`): Gemini 2.5 Pro 모델과 대화합니다. 메시지를 보내거나, 봇의 메시지에 답장하여 대화를 이어갈 수 있습니다.
- \`/map\`: Google 지도 기능이 활성화된 상태로 Gemini 2.5 Pro 모델과 대화합니다. 위치 기반 질문이나 길찾기 등에 활용할 수 있습니다.
- \`/image\` (별칭: \`/img\`): Gemini 2.5 Flash Image 모델을 사용하여 프롬프트를 기반으로 이미지를 생성합니다. 텍스트 프롬프트와 함께 사진을 첨부하여 이미지 관련 작업을 수행할 수도 있습니다.
